...
if __name__ == '__main__':
    try:
        ...
        if argc < 7 or argc > 8:
            die("Usage:" + NEW_LINE + 
                "python gofile-downloader.py <url> <gamename> <online> <dlc> <version> <downloaddir>" + NEW_LINE +
                "python gofile-downloader.py <url> <gamename> <online> <dlc> <version> <downloaddir> <password>"
            )

            url, gamename, online, dlc, version, downloaddir = argv[1:7]
